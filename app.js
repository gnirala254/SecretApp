...
const connString = "mongodb://admin-gautam:gautam254@" +
                   ...
                   "/userDB?authSource=admin&replicaSet=atlas-zaf4e8-shard-0&ssl=true";
...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "https://calm-peak-28395.herokuapp.com/auth/google/secrets",
...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "https://calm-peak-28395.herokuapp.com",
    enableProof: true
  },
  function(accessToken, refreshToken, profile, cb) {
    console.log(profile);
